...
public class CardEntityOld {
    ...
    public CardEntityOld() {
    }

    public static CardEntityOld fromCsvDataV1(String[] data) {
    ...
    public static CardEntityOld fromCsvDataV2(String[] data) {
        CardEntityOld card = fromCsvDataV1(data);
    ...
    public CardEntityOld setCreatedAt(Long createdAt) {
    ...
    public CardEntityOld setBack(@NonNull String back) {
        this.back = back;
    ...
    public CardEntityOld setFront(@NonNull String front) {
        this.front = front;
        this.type = calculateType();
        return this;
    }
    ...
    public CardEntityOld setId(Long id) {
        this.id = id;
        return this;
    }
    ...
    public CardEntityOld setLearnScore(Integer learnScore) {
    ...
    public CardEntityOld setType(@NonNull Integer type) {
        this.type = type;
        return this;
    }
}
