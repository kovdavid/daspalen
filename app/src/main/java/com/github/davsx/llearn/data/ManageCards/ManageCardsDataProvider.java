package com.github.davsx.llearn.data.ManageCards;
...
public class ManageCardsDataProvider implements Filterable {
    private CardRepository cardRepository;
    private ArrayList<CardEntity> filteredCards;
    private ArrayList<CardEntity> allCards;

    public ManageCardsDataProvider(CardRepository cardRepository) {
    ...
    public Filter getFilter() {
        return new Filter() {
            ...
            protected void publishResults(CharSequence charSequence, FilterResults filterResults) {
                ManageCardsDataProvider.this.filteredCards = (ArrayList<CardEntity>) filterResults.values;
            }
        };
    }
}