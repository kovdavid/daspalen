...
public class FragmentChoice1of4Reverse extends LearnQuizFragmentBase implements View.OnClickListener {
    ...
    public void onResume() {
        ...
        textViewQuiz.setText(learnQuizData.getBackText());
    ...
    public void onClick(View v) {
        ...
        String correctAnswer = learnQuizData.getFrontText();
